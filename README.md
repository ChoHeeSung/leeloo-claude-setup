...
| **leeloo-util** | 1.0.0 | Leeloo 범용 유틸리티 모음 — ITS 도면 분석, 공문서(HWP/HWPX/PDF) 변환 등 |
...
Leeloo 범용 유틸리티 모음. ITS 도면 분석, 공문서(HWP/HWPX/PDF) 변환 등 다양한 현장 업무 자동화 스킬을 제공합니다.
...
### /lk-iu-pdf-extract 사용법 (leeloo-util)
...
- **네임스페이스 분리** — lk- / lk-n8n- / lk-bb- / lk-iu- / lk-hwp- 접두사로 충돌 방지
