...
- Skills: lk-doc-pdf-extract, lk-doc-parse, lk-doc-compare, lk-doc-form, lk-git-init
...
- **네임스페이스 분리**: lk- (leeloo-kit) vs lk-n8n- (leeloo-n8n) vs lk-bb- (leeloo-bitbucket) vs lk-doc- / lk-git- (leeloo-util) vs lk-its- (its-ddl-tool) 접두사로 skill 충돌 방지.
...
- `Edit /Users/heesung/work/M_CHO/leeloo-claude-setup/leeloo-kit/scripts/session-end.js` — {"filePath":"/Users/heesung/work/M_CHO/leeloo-claude-setup/leeloo-kit/scripts/se
